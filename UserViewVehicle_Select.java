 ...
 * @author vivek
 */
public class UserViewVehicle_Select extends javax.swing.JFrame {
    ...
    public UserViewVehicle_Select(int CustomerID) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserViewVehicle_Select.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserViewVehicle_Select(0).setVisible(true);
            }
        });
    }
